...
SECRET_KEY = 'django-insecure-hw%x28zb86$!*e0lz6_-cxt38b25a93x4p4f3e=f(l3s$*bn6&'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'client_project',  # Replace with your PostgreSQL database name
        'USER': 'postgres',        # Replace with your PostgreSQL username
        'PASSWORD': 'sanjay',  # Replace with your PostgreSQL password
